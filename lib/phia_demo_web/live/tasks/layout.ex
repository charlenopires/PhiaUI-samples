defmodule PhiaDemoWeb.Demo.Tasks.Layout do
  @moduledoc "Tasks app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:tasks} dark_mode_id="tasks-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Tasks</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">Issue Tracker</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Views">
              <.nav_item current_path={@current_path} href="/tasks" icon="list" label="All Issues" badge={24} />
              <.nav_item current_path={@current_path} href="/tasks" icon="user" label="My Issues" badge={5} />
              <.nav_item current_path={@current_path} href="/tasks" icon="zap" label="In Progress" badge={8} />
            </.nav_section>
